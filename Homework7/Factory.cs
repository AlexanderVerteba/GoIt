...
namespace Homework7
{
    static class Factory
    {
        ...
        static void AddIntern()
        {
            Console.Clear();
            Console.WriteLine("He would like to be:");
            Console.WriteLine("1.Doctor \n2.Psycho \n3.Security \n4.Simple employee");
            string input = Console.ReadLine();
            int choice;
            Int32.TryParse(input, out choice);
            ...
            {
                case 1:
                    list.Add(new InternDoctor());
                    break;
                case 2:
                    list.Add(new InternPsycho());
                    break;
                case 3:
                    list.Add(new InternSecurity());
                    break;
                case 4:
                    list.Add(new InternEmployee());
                    break;
                default:
                    Console.WriteLine("Oops!");
                    break;
        ...
        static void FindWorker()
        {
            ...
            foreach (var w in list)
            {
                if (w._sName == name)
                {
                    ...
                    if (w is InternDoctor) Console.WriteLine("Intern(Doctor)");
                    else if (w is InternPsycho) Console.WriteLine("Intern(Psycho)");
                    else if (w is InternSecurity) Console.WriteLine("Intern(Security)");
                    else if(w is InternEmployee) Console.WriteLine("Intern(Employee)");
                    else if (w is Doctor) Console.WriteLine("Doctor");
            ...
            if (!i) Console.WriteLine("There is no worker with that name.");
        }
    }
}
